...
import org.camunda.bpm.extension.test.mockito.query.AuthorizationQueryMock;
import org.camunda.bpm.extension.test.mockito.query.DeploymentQueryMock;
import org.camunda.bpm.extension.test.mockito.query.DeploymentStatisticsQueryMock;
import org.camunda.bpm.extension.test.mockito.query.EventSubscriptionQueryMock;
import org.camunda.bpm.extension.test.mockito.query.ExecutionQueryMock;
import org.camunda.bpm.extension.test.mockito.query.GroupQueryMock;
import org.camunda.bpm.extension.test.mockito.query.HistoricActivityInstanceQueryMock;
import org.camunda.bpm.extension.test.mockito.query.HistoricDetailQueryMock;
import org.camunda.bpm.extension.test.mockito.query.HistoricIncidentQueryMock;
import org.camunda.bpm.extension.test.mockito.query.HistoricProcessInstanceQueryMock;
import org.camunda.bpm.extension.test.mockito.query.HistoricTaskInstanceQueryMock;
import org.camunda.bpm.extension.test.mockito.query.HistoricVariableInstanceQueryMock;
import org.camunda.bpm.extension.test.mockito.query.IncidentQueryMock;
import org.camunda.bpm.extension.test.mockito.query.JobDefinitionQueryMock;
import org.camunda.bpm.extension.test.mockito.query.JobQueryMock;
import org.camunda.bpm.extension.test.mockito.query.ProcessDefinitionQueryMock;
import org.camunda.bpm.extension.test.mockito.query.ProcessDefinitionStatisticsQueryMock;
import org.camunda.bpm.extension.test.mockito.query.ProcessInstanceQueryMock;
import org.camunda.bpm.extension.test.mockito.query.TaskQueryMock;
import org.camunda.bpm.extension.test.mockito.query.UserOperationLogQueryMock;
import org.camunda.bpm.extension.test.mockito.query.UserQueryMock;
