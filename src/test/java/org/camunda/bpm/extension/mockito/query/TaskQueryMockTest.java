...
import static org.camunda.bpm.extension.mockito.query.QueryMocks.*;
...
public class TaskQueryMockTest {
    ...
    public void should_mock_query_and_return_singleResult() {
        final TaskQuery taskQuery = mockTaskQuery(taskService).singleResult(singleResult);
    ...
    public void singleResult_for_activityName() {
        mockTaskQuery(taskService).singleResult(singleResult);
